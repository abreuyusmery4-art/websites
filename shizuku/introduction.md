...
The name Shizuku comes from [a character](https://danbooru.donmai.us/posts/355
3474).
...
4. (Pie+) Execute the native program `cmd` ([see here](https://android.googleso
5. urce.com/platform/frameworks/native/+/pie-release/cmds/cmd/))
